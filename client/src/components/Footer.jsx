...
import WorkHiveLogo from "./FiverrLogo"; // Updated the logo component name
  ...
  const data = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Selling on WorkHive", link: "#" },
        { name: "Buying on WorkHive", link: "#" },
      ],
    },
    {
    ...
    {
      headerName: "Move From WorkHive",
      links: [
        { name: "WorkHive Business", link: "#" },
        { name: "WorkHive Pro", link: "#" },
        { name: "WorkHive Logo Maker", link: "#" },
        { name: "WorkHive Guides", link: "#" },
        { name: "Get Inspired", link: "#" },
        { name: "WorkHive Select", link: "#" },
        { name: "ClearVoice", link: "#" },
        { name: "WorkHive Workspace", link: "#" },
        { name: "Learn", link: "#" },
  ...
  return (
    <footer className="w-full  mx-auto px-32 py-16 h-max border-t border-gray-200 bg-gray-100">
      ...
      <div className="mt-12 flex items-center justify-between">
        <WorkHiveLogo fillColor={"#404145"} /> {/* Updated logo */}
